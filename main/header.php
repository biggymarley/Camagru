  ...
  <div id="header">
    ...
    <div id="itmheader">
      ...
      if(empty($_SESSION['usersid']))
      {
        ...
        echo '<a href="../main/login.php" class="item">LOGIN</a>';
        echo '</li>';
        echo '<li class="hditemes">';
        echo '<a href="../main/signup.php" class="item">SINGUP</a>';
        echo '</li>';
      }
      else if(isset($_SESSION['usersid']))
      {
        ...
        echo '</li>';
        echo '<li class="hditemes">';
        echo '<a href="../main/profile.php" class="item">PROFILE</a>';
        echo '</li>';
        echo '<li class="hditemes">';
        echo '<a href="../main/imglab.php" class="item">IMG-LAB</a>';
        echo '</li>';
        echo '<li class="hditemes">';
